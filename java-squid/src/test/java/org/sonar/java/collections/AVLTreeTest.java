...
public class AVLTreeTest {
  ...
  public void test() {
    ...
    assertThat(t.iterator()).hasSize(100);
    assertThat(t.height())
  ...
  public void hashCode_equals_test() {
    ...
    assertThat(t.iterator()).hasSize(2);
    assertTrue(Iterators.elementsEqual(t.iterator(), t2.iterator()));
    assertThat(t.iterator()).containsOnly(new AbstractMap.SimpleImmutableEntry(1, 1), new AbstractMap.SimpleImmutableEntry(2, 2));
    t2 = t2.add(3);
    assertThat(t.hashCode()).isNotEqualTo(t2.hashCode());
    assertThat(t).isNotEqualTo(t2);
    assertThat(t2.iterator()).hasSize(3);
    t = t.put(3, 33);
    assertThat(t).isNotEqualTo(t2);
    t = t.add(3);
    assertThat(t).isEqualTo(t2);
    t = t.add(4);
    assertThat(t).isNotEqualTo(t2);
    assertThat(t.iterator()).hasSize(4);
  ...
  public void iterator_no_such_element_exception() {
    AVLTree<Integer, Object> t = AVLTree.create();
    t = t.add(1);
    Iterator<Map.Entry<Integer, Object>> iterator = t.iterator();
    iterator.next();
    iterator.next();
  }
